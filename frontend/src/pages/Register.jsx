    ...
    <div>
         <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div>
                            <label htmlFor="string" className="block text-sm font-medium leading-6 text-gray-900">
                                First Name
                            </label>
                            <div className="mt-2">
                                <input
                    ...
                    <p className="mt-10 text-center text-sm text-gray-500">
                        ...
                        <Link to="/login" className="font-semibold leading-6 text-blue-600 hover:text-blue-700">
                            Log in
                        </Link>
                    </p>
                </div>
